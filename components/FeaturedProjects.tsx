...
<Link
href="/projects"
className="rounded-full border border-neutral-200/80 bg-white px-4 py-2 text-sm font-semibold text-neutral-800 shadow-sm transition hover:bg-neutral-50 dark:border-neutral-800/70 dark:bg-neutral-950/30 dark:text-neutral-200 dark:hover:bg-neutral-950/60"
>
View all
</Link>
</div>
